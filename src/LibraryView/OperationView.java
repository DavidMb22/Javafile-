...
import LibraryDao.CheckInOutDao;
...
public class OperationView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        checkClientId = new javax.swing.JButton();
        checkBookId = new javax.swing.JButton();
        ...
        checktable.setBackground(new java.awt.Color(0, 204, 0));
        ...
        checkClientId.setText("CID");
        checkClientId.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                checkClientIdActionPerformed(evt);
            }
        });

        checkBookId.setText("BID");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(imagedisplay, javax.swing.GroupLayout.DEFAULT_SIZE, 155, Short.MAX_VALUE)))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(28, 28, 28)
                        .addComponent(checkClientId)))
                .addGap(148, 338, Short.MAX_VALUE))
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(115, 115, 115)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(0, 0, Short.MAX_VALUE))
                    .addComponent(imagedisplay, javax.swing.GroupLayout.DEFAULT_SIZE, 108, Short.MAX_VALUE))
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel6)
    ...
    private void btnCheckOutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCheckOutActionPerformed
        // TODO add your handling code here:
        Checkinout chout = new Checkinout();
        chout.setClientname(txtclientId.getText());
        chout.setBookname(txtbookname.getText());
        chout.setAuthor(txtauthor.getText());
        chout.setDatetime(dob.getDate());
        chout.setStatus("Check Out");
        CheckInOutDao choutdao= new CheckInOutDao();
    ...
    private void btnSearchClientActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSearchClientActionPerformed
        // TODO add your handling code here:
        int f=0;
        String clname =txtclientId.getText();
        ...
        if (txtclientid.getText().isEmpty()){
            ...
            for (Object cl:ls){
                ...
                if (cname.equals(cld)){
                    ...
                    for(Object crn : rn)
                    {
                        txtclientId.setText(crn.toString());
                    }
                    break;
                }
            }
    ...
    private void checkClientIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_checkClientIdActionPerformed
        // TODO add your handling code here:
        ClientView cl = new ClientView();
        cl.setVisible(true);
    }//GEN-LAST:event_checkClientIdActionPerformed
    ...
    private javax.swing.JButton checkBookId;
    private javax.swing.JButton checkClientId;
    ...
    private void PopulateCheckOut() {
        CheckInOutDao cdao= new CheckInOutDao();
        List<Checkinout> ck= cdao.getCheckOut();
        ...
        for(Iterator iter =ck.iterator();iter.hasNext();){
            Checkinout cm =(Checkinout) iter.next();
            Object [] client = {cm.getClientname(),cm.getBookname(),cm.getAuthor(),cm.getDatetime(),cm.getStatus()};
            tm.addRow(client);
